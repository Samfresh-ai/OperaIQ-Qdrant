import { z } from "zod";
import { qdrantMemoryQuery, qdrantMemorySearch, type QdrantSearchResult } from "@operaiq/qdrant-mcp";
...
export const queryQdrantLogs = queryQdrantMemory;
export const queryQdrantLogsDefinition = queryQdrantMemoryDefinition;
export type QueryQdrantLogsResult = QueryQdrantMemoryResult;

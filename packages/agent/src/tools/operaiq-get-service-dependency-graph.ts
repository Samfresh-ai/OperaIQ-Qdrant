...
export const operaiqGetServiceDependencyGraphInputSchema = z.object({
...
export async function operaiqGetServiceDependencyGraph(input: unknown): Promise<ServiceDependencyGraph | null> {
  const parsed = operaiqGetServiceDependencyGraphInputSchema.parse(input);
...
export const operaiqGetServiceDependencyGraphDefinition: AgentToolDefinition = {
